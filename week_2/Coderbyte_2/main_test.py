...
class TestTour(unittest.TestCase):
    ...
    def test_tsp_3_insert_smallest(self):
        ...
        for p in self.tsp_3:
            smallest_tour.insert_smallest(p)
        self.assertAlmostEqual(smallest_tour.distance(),
                               832.4555320336758, places=2)
    ...
    def test_tsp_3_insert_nearest(self):
        ...
        for p in self.tsp_3:
            nearest_tour.insert_nearest(p)
        self.assertAlmostEqual(nearest_tour.distance(),
                               832.4555320336758, places=4)
